...
export function SourceList({ onNext, onPrev, canGoNext, canGoPrev }: ScreenProps) {
  return (
    <div className="flex flex-col h-full p-8">
      <h1 className="text-2xl font-bold text-gray-900 mb-4">Fontes / Manuscritos</h1>
      <p className="text-gray-500 mb-8">Tela 2 de 5 — Lista de fontes e metadados (Fase 3)</p>
